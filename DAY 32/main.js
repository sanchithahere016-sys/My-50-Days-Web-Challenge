...
async function handleSubmitInitiative(
    ...
    try {
        const serverResponse =
            await submitInitiative(dataPayload);

        console.log(
            "Server Confirmation Payload:",
            serverResponse
        );
        ...
        feedbackMessage.innerHTML = `
            <p style="color: green; font-weight: bold; margin-top: 15px;">
                ...
                (Resource ID Assigned: ${serverResponse.id})
            </p>
        `;
